...
function NumberToLetter( nombre ){
	...
	switch( n ){
		 ...
		 case 3: quotient = Math.floor(nb / 100);
				 ...
				 if(  quotient == 1 && reste != 0   ) numberToLetter = "cent" + " " + NumberToLetter(reste) + " millimes ";
		 ...
		 case 4 :  quotient = Math.floor(nb / 1000);
					  ...
					  if(  quotient == 1 && reste == 0   ) numberToLetter = "dinars";
					  if(  quotient == 1 && reste != 0   ) numberToLetter = "dinars" + " " + NumberToLetter(reste);
					  if(  quotient > 1 && reste == 0    ) numberToLetter = NumberToLetter(quotient) + " dinars";
					  if(  quotient > 1 && reste != 0    ) numberToLetter = NumberToLetter(quotient) + " dinars " + NumberToLetter(reste);
					  break;
